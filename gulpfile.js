...
var SCRIPTS_PATH = 'src/js/{libs,**}/*.js',
    ...
    IMG_PATH = 'src/{**/images/*.{png,jpeg,jpg,gif,svg},images/*.{png,jpeg,jpg,gif,svg}',
...
var DIST_DIR = 'dist',
    ...
    DIST_JS = 'dist/**/js',
    DIST_IMG = 'dist/{**/images/*.{png,jpeg,jpg,gif,svg},images/*.{png,jpeg,jpg,gif,svg}',
...
var TEST_DIR = 'test',
    ...
    TEST_JS = 'test/**/js',
    TEST_IMG = 'test/{**/images/*.{png,jpeg,jpg,gif,svg},images/*.{png,jpeg,jpg,gif,svg}}';
